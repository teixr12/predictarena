...
export const getStaticProps = async () => {
  try {
    ...
    const latestCalibrationData = result.data?.[0]?.data as
      | { points?: { x: number; y: number }[]; score?: number; n?: number }
      | undefined
    const points = latestCalibrationData?.points ?? []
    const score = latestCalibrationData?.score ?? 0
    const n = latestCalibrationData?.n ?? 0
  ...
  return (
    <Page trackPageView={'platform calibration page'}>
      <SEO
        ...
        description="PREDICTA Arena's overall track record"
      />
      ...
      <Col className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-ink-600 max-w-2xl text-lg leading-relaxed">
            Explore how PREDICTA Arena's predictions compare to real-world outcomes.
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <CaseStudyCard
              ...
              contract={sbfMarket}
              description="PREDICTA Arena had a market stable between 5-10% that SBF would be convicted of a felony 1-month before there was any news about it. It then immediately reacted correctly to rumors before any official statements were made."
            />
