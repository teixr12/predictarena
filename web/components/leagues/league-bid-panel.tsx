    ...
    <Col className="gap-2">
      <Row className="items-center gap-2">
        <div className="text-ink-600 text-sm">
          ...
          <InfoTooltip
            text={
              'At the end of the season, the owner of the league will gain coins equal to the total coins earned of every user in the league. Note: you can lose coins if the total is negative!'
            }
          />
        </div>
      </Row>
