  ...
  return (
    <>
      <div className="text-primary-700 text-center text-2xl font-normal">
        How PREDICTA Arena works
      </div>

      <span className="mt-4 md:mt-6">
        PREDICTA Arena has 2 coins that you can {TRADE_TERM} with:
      </span>
      ...
      <div className="text-ink-500 my-2 text-xs">
        You must be 18+ to participate. PREDICTA Arena is free to play, no purchase
        required.
      </div>
    </>
  )
